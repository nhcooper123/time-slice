...
Disparity changes through time for each of our four datasets (Figure \ref{figure:dtt1}, Supporting Information Appendix S2: Figure AX and Tables AX-X). % add details of appendix
...
Results for all six methods can be found in Supporting Information Appendix S2: Figure AX. % add details of appendix
  ...
  \begin{figure}[!htbp]
    ...
    Results for stratigraphic ages, and for other time-slicing methods, are in the Supporting Information Appendix S2: Figure X} %appendix
    \label{figure:dtt1}
  \end{figure}
...
% Plots showing the differences
  \begin{figure}[!htbp]
    ...
    Results for stratigraphic ages, and for other time-slicing methods, are in the Supporting Information Appendix S2: Figure AX} %appendix
    \label{figure:peak1}
  \end{figure}
