...
Disparity through time analysis are really popular and routinely applied on palaeobiological datasets.
...
Additionally, this method allows to use all the phylogenetic data available (tips, nodes \textit{and} branches) and specify the implied model of evolution between each time-slice (punctuated or gradual).
