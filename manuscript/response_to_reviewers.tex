...
%TG: tone done the statement? % NC: yeah, not sure what else we can do. %TG: Does that kinda work? NC: sounds ok to me, I tidied the english.
...
\textit{Finally, the difference between the time-binning and time-slicing results could also simply be due to the nature of the fossil record.
...
Additionally, this effect is likely to be most obvious in vertebrates and less problematic for groups like Foraminifera.} lines @@@

% NC: Had to edit this quite a bit to make the English make sense. Does it still convey your meaning wrt forams?
