...
Morphospaces can be obtained from any multidimensional morphological data set but can differ in the data used (e.g. discrete or continuous), and whether they include phylogenetic data or not. % NC: do you mean cladistic data i.e.e data used to build phylogenies?
...
% NC: Ha yeah the reason it's not like in Fig 2 is that it was a pain in the ass. I partly did all these in ggplot because I'm trying to get better at it. Will work on this.
...
% NC: No! The lines are misleading, technically must be points, as lines suggest there is data throughout rather than at discrete points. Bit of a bugbear of mine...
...
% NC: For simplicity I suggest we put them here too, then it's easy for the editor to just tick them off rather than having to check. Also makes sure that we definitely do it all!
