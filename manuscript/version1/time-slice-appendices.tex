...
%\begin{landscape}
%  \input{tables/disparity_measurement-Beck2014.tex} 
%\end{landscape}

%\newpage
%\begin{landscape}
%  \input{tables/disparity_measurement-Brusatte2014.tex} 
%\end{landscape}

%\newpage
%\begin{landscape}
%  \input{tables/disparity_measurement-Bapst2016.tex} 
%\end{landscape}

%\newpage
%\begin{landscape}
 % \input{tables/disparity_measurement-Wright2017.tex}  
%\end{landscape}
