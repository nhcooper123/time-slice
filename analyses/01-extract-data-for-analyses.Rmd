...
And that's it... we now have all the arguments for running the `dispRity` package properly: the space (`morphospace`), the tree (`tree`) and the FADLAD (`FADLAD`). Remember that for the `time.subsets` function, you can use the `inc.nodes` logical option to include nodes or not!
