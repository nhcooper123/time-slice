...
```{r}
## Loading the matrix
readRDS(paste0("../data/processed/ancestral_states.", slug ,".Rda"))
...
And that's it... we now have all the processed data for running the `dispRity` package properly: the distance matrices(that we will use to build the `morphospace`), and the cleaned tree (`tree`). Remember that for the `time.subsamples` function, you can use the `inc.nodes` logical option to include nodes or not!
