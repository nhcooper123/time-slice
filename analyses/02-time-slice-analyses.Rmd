...
models <- list("equalbins", "acctran", "deltran", "random", "proximity")
...
## Comparing the disparity through time curves

```{r}
curve1 <- out2$object[[1]][[1]]
curve2 <- out2$object[[1]][[2]]
curve3 <- out2$object[[1]][[3]]
curve4 <- out2$object[[1]][[4]]
curve5 <- out2$object[[1]][[5]]
