...
```{r}
# Make mini dataframe for annotations
ann_text <- data.frame(model = "bins", time1 = 20, bin_type = "stratigraphy")
...
wright_peaks <- 
 ...
 theme(axis.title.y = element_blank(),
       ...
       panel.spacing = unit(0, "lines"),
        panel.border = element_blank(),
        strip.text = element_blank()) +
 geom_text(data = ann_text, aes(x = 1, y = 465, 
...
pdf("../manuscript/figures/fig-peaks-epoch-revision.pdf")  
...
pdf("../manuscript/figures/fig-peaks-age-revision.pdf")  
